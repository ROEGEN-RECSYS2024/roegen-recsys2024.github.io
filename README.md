<style>
  ...
  .important-dates, .organizers, .committee {
  ...
  .important-dates h3, .organizers h3, .committee h3 {
    color: #444;
  }
</style>
...
<div class="container">
  ...
  Submissions must be anonymized and adhere to the specified formatting guidelines, which will be provided on the workshop website. The submission site is [EasyChair RecSys 2024](xxx).
